...
export const BASE_URL = "https://believes-entries-grown-avoid.trycloudflare.com";
export const WEBSOCKET_URL = "ws://believes-entries-grown-avoid.trycloudflare.com";
